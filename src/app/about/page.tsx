                ...
                <div className="grid grid-cols-1 lg:grid-cols-[1fr_280px]">
                    ...
                    <div className="p-6 lg:p-8">
                        ...
                        <div className="text-[0.78rem] leading-[2.2] text-neutral-500">
                            ...
                            <Link href="#" className="text-xs uppercase tracking-[0.1em] text-[#ff3333] font-light">LinkedIn →</Link><br />
                            <Link href="#" className="text-xs uppercase tracking-[0.1em] text-[#ff3333] font-light">Newsletter →</Link>
                        </div>
