            ...
            <section className="bg-white border-b border-neutral-200">
                <div className="grid grid-cols-1 lg:grid-cols-[1fr_280px]">
                    ...
                    <div className="p-8 md:p-12 lg:border-r border-neutral-200">
                        ...
                        {/* Pullquote */}
                        <div className="border-l-[3px] border-[#0d6f7c] px-6 py-4 my-8 bg-neutral-50">
                    ...
                    <div className="p-6 lg:p-8">
                        ...
                        <div className="text-[0.78rem] leading-[2.2] text-neutral-500">
                            ...
                            <Link href="#" className="text-xs uppercase tracking-[0.1em] text-[#0d6f7c] font-light">LinkedIn →</Link><br />
                            <Link href="#" className="text-xs uppercase tracking-[0.1em] text-[#0d6f7c] font-light">Newsletter →</Link>
                        </div>
