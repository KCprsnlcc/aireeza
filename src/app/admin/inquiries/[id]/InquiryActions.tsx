    ...
    <div className="relative">
      <div className="flex items-center gap-2">
        ...
        <button
          ...
          disabled={isUpdating}
          className="inline-flex items-center justify-center w-8 h-8 rounded-lg transition-all duration-500 bg-teal-50 text-[#107f87] hover:bg-teal-100 disabled:opacity-50 disabled:cursor-not-allowed border border-teal-200"
        >
