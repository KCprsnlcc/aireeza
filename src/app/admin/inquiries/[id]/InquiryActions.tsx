    ...
    <div className="relative">
      <div className="flex items-center gap-2">
        ...
        <button
          ...
          disabled={isUpdating}
          className="inline-flex items-center justify-center w-8 h-8 rounded-lg transition-all duration-500 bg-blue-50 text-[#0066CC] hover:bg-blue-100 disabled:opacity-50 disabled:cursor-not-allowed border border-blue-200"
        >
