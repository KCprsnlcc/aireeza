        ...
        <>
            ...
            <section className="grid grid-cols-1 md:grid-cols-2 border-b border-neutral-200 bg-white">
                ...
                <div className="p-8 md:p-10">
                    <div className="text-[0.65rem] uppercase tracking-[0.1em] text-[#0192af] mb-3 font-light">{featuredPost.tag}</div>
                    ...
                    <span className="text-xs uppercase tracking-[0.1em] text-[#0192af] font-light cursor-pointer hover:underline">Read →</span>
                </div>
            </section>
