        ...
        <>
            ...
            <section className="grid grid-cols-1 lg:grid-cols-[1.2fr_1fr] border-b border-neutral-200">
                ...
                <div className="px-6 md:px-8 lg:px-12 py-12 md:py-16 lg:py-20 border-b lg:border-b-0 lg:border-r border-neutral-200">
                    <div className="text-[0.65rem] uppercase tracking-[0.2em] text-[#0066CC] mb-4 font-light">
                        The Newsletter
                    </div>
                ...
                <div className="bg-neutral-900 text-white px-6 md:px-8 lg:px-12 py-12 md:py-16 lg:py-20 flex flex-col justify-between">
                    <div>
                        ...
                        <form onSubmit={handleSubscribe} className="flex flex-col gap-3">
                            ...
                            <button
                                type="submit"
                                className="text-[0.7rem] uppercase tracking-[0.1em] bg-[#0066CC] text-white px-6 py-3 font-light hover:bg-[#0052A3] transition-colors mt-1"
                            >
                                Subscribe →
                            </button>
            ...
            <section className="border-b border-neutral-200">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4">
                    {whatToExpect.map((item, index) => (
                        ...
                        >
                            <div className="text-[0.6rem] text-[#0066CC] mb-3 font-light">{item.num}</div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3">
                    {socialLinks.map((link, index) => (
                        ...
                        >
                            ...
                            <a
                                href={link.href}
                                className="text-[0.62rem] uppercase tracking-[0.1em] text-[#0066CC] mt-2 hover:text-[#0052A3] transition-colors"
                            >
                                {link.cta}
                            </a>
                        </div>
