...
export default function WhoIWorkWith() {
    return (
        <section id="who-i-work-with" className="py-16 border-b relative overflow-hidden border-neutral-200 bg-white">
            ...
            <div className="w-full px-6 relative z-10">
                ...
                <p className="text-center text-sm font-light leading-relaxed max-w-4xl mx-auto mb-16 tracking-normal text-neutral-700">
                    I work best with leaders who view finance as a decision making tool, not a reporting function.
                </p>

                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
                    <div className="slide-in-left">
                        <h2 className="text-4xl md:text-5xl font-black tracking-tighter mb-8 text-black">I Typically Work With</h2>
                        <p className="text-sm font-light leading-relaxed mb-6 text-neutral-600">These engagements tend to involve ambiguity, tradeoffs, and a need for clear judgment.</p>
                        <ul className="space-y-4">
                            <li className="flex items-start gap-3 pb-3 border-b stagger-item border-neutral-200">
                                <Icon icon="solar:check-circle-linear" className="text-lg mt-1 flex-shrink-0" />
                                <span className="text-sm font-light leading-relaxed text-neutral-700">
                            ...
                            <li className="flex items-start gap-3 stagger-item text-neutral-700">
                                <Icon icon="solar:check-circle-linear" className="text-lg mt-1 flex-shrink-0" />
                                <span className="text-sm font-light leading-relaxed text-neutral-700">
                    ...
                    <div className="slide-in-right">
                        <h2 className="text-4xl md:text-5xl font-black tracking-tighter mb-8 text-neutral-500">I Am Not A Fit For</h2>
                        <p className="text-sm font-light leading-relaxed mb-6 text-neutral-600">These engagements typically require different expertise or are misaligned with my strategic approach.</p>
                        <ul className="space-y-4">
                            <li className="flex items-start gap-3 pb-3 border-b border-neutral-200">
                ...
                <div className="mt-16 pt-8 border-t text-center fade-up border-neutral-200">
                    <p className="text-sm font-light leading-relaxed tracking-wide mb-4 text-neutral-600">This work requires openness, accountability, and a willingness to engage with the numbers honestly.</p>
                    <p className="text-sm font-light leading-relaxed tracking-wide mb-6 text-neutral-600">If that resonates, the next step is a focused conversation to determine fit.</p>
                    <div className="mt-6">
                        <a 
                            href="#contact" 
