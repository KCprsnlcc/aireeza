        ...
        <section className="relative bg-white border-b border-neutral-200">
            ...
            <div className={`grid grid-cols-1 md:grid-cols-3 opacity-0 ${isLoaded ? 'hero-animate-in hero-stagger-2' : ''}`}>
                {services.map((service, i) => (
                    ...
                    >
                        <div className="text-[0.65rem] text-[#0066CC] mb-4 font-light">{service.num}</div>
                        ...
                        <Link
                            href="/services"
                            className="text-xs uppercase tracking-[0.1em] text-[#0066CC] hover:underline mt-5 inline-block font-light"
                        >
                            Explore →
                        </Link>
                    </div>
