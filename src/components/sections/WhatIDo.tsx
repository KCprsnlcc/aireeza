...
export default function WhatIDo() {
    ...
    return (
        <section id="what-i-do" className={`py-16 border-b relative overflow-hidden ${
            ...
            <div className="w-full px-6 relative z-10">
                ...
                <div className="flex justify-between items-start mb-8">
                    <div className="w-full md:w-1/2">
                        ...
                        <h2 className={`text-4xl md:text-6xl font-black tracking-tighter leading-[0.7] ${
                            theme === 'dark' ? 'text-white' : 'text-black'
                        }`}>
                            CLARITY
                            <span className={`block text-3xl md:text-5xl font-light tracking-[0.2em] text-center mt-2 ${
                    ...
                    <div className="w-full md:w-1/3 flex justify-end items-end h-full pt-6 md:pt-0">
                        <p className={`text-xs font-light leading-relaxed max-w-xs text-right tracking-wide ${
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 relative">
                    ...
                    <div className={`absolute left-1/2 transform -translate-x-1/4 -top-16 p-3 border z-20 ${
                        theme === 'dark' 
                    ...
                    {/* Service 1 */}
                    <div className={`group border transition-all duration-700 overflow-hidden zoom-in ${
                        theme === 'dark' 
                        ...
                        <div className="p-6 h-full flex flex-col">
                            <div className={`h-12 w-12 border rounded-full flex items-center justify-center mb-6 transition-all duration-500 flex-shrink-0 ${
                                theme === 'dark'
                            ...
                            <div className={`overflow-hidden flex-1 group-hover:animate-marquee ${
                                theme === 'dark' ? 'text-neutral-400' : 'text-neutral-600'
                            }`}>
